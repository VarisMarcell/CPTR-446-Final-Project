...
let UsersService = class UsersService {
    ...
    async update(id, updateUserDto) {
        try {
            const existingUser = await this.em.findOneOrFail(user_entity_1.User, { id: id }, { populate: ['queue'] });
            ...
            if (updateUserDto.queue) {
                for (let songId of updateUserDto.queue) {
                    existingUser.queue.add(this.em.getReference(song_entity_1.Song, songId));
                }
            }
